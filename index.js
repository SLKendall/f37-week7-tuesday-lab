...
// ANSWER: O(n), techincally 0(1) because numbers is a defined array

// Q: What is the space complexity?
// ANSWER: O(n), technically O(1) because numbers is a defined array
...
// ANSWER: function getNumbersSquared(numbers) {
//   let answers = []
//     for (let i = 0; i < numbers.length; i++) {
...
// ANSWER:No they don't have the same space complexity


// Q: What is the space complexity of each? 
// ANSWER - countLetters: 0(n)
// ANSWER - countLettersRoundTwo: 0(1)


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER: In the first function countLetters, the function is increasing linearly in space complexity due to the splitStr variable being dependent on the str function.
//The second function, countLettersRoundTwo, is fixed because the letter Regular Expression creates a limit for the array to at max be 26 letter objects. The for loop that iterates simply increases 
//the number of those letter objects. Theres no increase in complexity regardless of how large or small the str variable is.
